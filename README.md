...
Il est aussi important d'avoir les couches admin express des département (https://geoservices.ign.fr/adminexpress)et des régions de France stocké dans un dossier admin_express. 
Il va falloir pour son fonctionnement préparer les données avec le script "prepare_carto_simple.R" en espérant que ce code va vous plaire 
